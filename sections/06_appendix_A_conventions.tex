...
$\widetilde F_5$ the
self-dual five-form.  This schematic expression fixes notation only;
Lecture~2 uses the four-dimensional period and superpotential data
rather than the full ten-dimensional pseudo-action.  The norm
$|\partial\tau|^2_\tau$ uses the hyperbolic metric on the upper
half-plane.
